                        ...
                        <div class="formLogin">
                            <form id="form" method="post" class="j-login-form u-form">
                                <div class="inputArea">
                                    ...
                                    <div class="u-form-item u-form-item-1 forPassword">
                                        <div class="wrapper">
                                            <label class="label"><input type="checkbox" v-model="isRemember" /></label>
                                            <div class="input-wrapper">
                                                <div class="sub-input-wrapper">
                                                    <input class="u-input" type="text" name="remember" id="remember" placeholder="记住我（请不要在公开设备选择该选项）" tabindex="3" value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="u-form-item u-form-item-2" style="display: flex; justify-content: space-between">
                                    <button class="u-btn u-btn-primary submit" type="button" v-on:click="MySubmit">
                                        登录
                                    </button>
                                    <button class="u-btn u-btn-default submit" type="button" v-on:click="$router.push('/register')">
                                        注册
                                    </button>
                                </div>
                            </form>
